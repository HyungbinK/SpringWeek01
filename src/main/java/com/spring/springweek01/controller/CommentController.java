...
import com.spring.springweek01.service.CommentService;
...
//    public List<Comment> getComments(@PathVariable("id") Long boardId) {
//        //게시글 번호로 코멘트를 조회해서 해당하는 코멘트만 리턴
//        return commentRepository.findByBoardIdOrderByModifiedAtDesc(boardId);
//    }
...
//    //코멘트 수정
//    @PutMapping("/api/boards/{boardId}/comments/{commentId}")
